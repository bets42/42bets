...
"""Configures a server by sending a set of commands

The script connects to a trading engine via it's command port and executes 
a serious of admin commands described in the config file provided as an argument; 
the config file is a Python module invoking a series of commands upon the server.
